...
function insertNewRecord(data) {
    ...
    cell2.innerHTML = data.buyerEmail;
...
function onEdit(td) {
    ...
    document.getElementById("buyerEmail").value = selectedRow.cells[1].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[1].innerHTML = formData.buyerEmail;
